...
var handleSubmit = function handleSubmit(e) {
  ...
  if (!currentLoan) {
    ...
    form.querySelector('#loan-payment').innerHTML = "$".concat(currentLoan.payment().toFixed(2)); // the loans list should update its display whenever a loan is changed
    ...
    form.querySelector('#loan-payment').innerHTML = "$".concat(currentLoan.payment().toFixed(2));
  }
...
var handleResetClick = function handleResetClick(e) {
...
var handleListClick = function handleListClick(e) {
...
var renderLoansList = function renderLoansList() {
